...
> **Vertical:** {{VERTICAL}}  (e.g. NDT, PI Law, MSP, Medical, Internal)
> **Started:** {{START_DATE}}
...
- [ ] Replace `{{PROJECT_NAME}}`, `{{VERTICAL}}`, `{{START_DATE}}`, `{{PROJECT_DESCRIPTION}}`
- [ ] Fill in `context/TELOS/` files with project-specific content
- [ ] Update `context/strategy.md` for this project
- [ ] Update `context/current-data.md` with current metrics
