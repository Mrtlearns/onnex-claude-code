...
2. `context/personal-info.md` — who you're working with (summary)
3. `context/business-info.md` — Onnex overview (summary)
4. `context/TELOS.md` — TELOS index and cross-reference map
5. `context/TELOS/MISSION.md` — core missions
6. `context/TELOS/GOALS.md` — active goals and milestones
7. `context/TELOS/PROJECTS.md` — active and planned projects
8. `context/TELOS/CHALLENGES.md` — current obstacles
9. `context/TELOS/STRATEGIES.md` — how we're addressing them
10. `context/strategy.md` — THIS project's specific strategy
11. `context/current-data.md` — current metrics and state
