...
Read:
1. `projects/pi-lawyer-os/.planning/PROJECT.md` — product overview, tech stack
2. `projects/pi-lawyer-os/.planning/REQUIREMENTS.md` — find Phase {phase_number} requirements
3. `projects/pi-lawyer-os/.planning/ROADMAP.md` — find Phase {phase_number} roadmap entry
4. `projects/pi-lawyer-os/.planning/STATE.md` — current decisions and completed work
5. `projects/pi-lawyer-os/.planning/phases/0{phase_number}-*/01-CONTEXT.md` — existing context file for this phase (if any)
