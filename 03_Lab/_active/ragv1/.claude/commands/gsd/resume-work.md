...
Read:
1. `projects/pi-lawyer-os/.planning/STATE.md` — current milestone, phase, session log
2. `projects/pi-lawyer-os/.planning/phases/` — find any phase with status "In Progress"

```bash
git status
git log --oneline -5
ls projects/pi-lawyer-os/.planning/phases/
```
