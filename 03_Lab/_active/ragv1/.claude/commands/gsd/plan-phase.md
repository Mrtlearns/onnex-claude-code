...
Read:
1. `projects/pi-lawyer-os/.planning/PROJECT.md` — tech stack, architecture decisions
2. `projects/pi-lawyer-os/.planning/REQUIREMENTS.md` — Phase {phase_number} requirements (find the right phase section)
3. `projects/pi-lawyer-os/.planning/ROADMAP.md` — Phase {phase_number} success criteria
4. `projects/pi-lawyer-os/.planning/phases/0{phase_number}-*/01-CONTEXT.md` — tech decisions and specifics for this phase
5. `projects/pi-lawyer-os/reference/` — architecture, schema, workflow references

**Step 2: Identify the phase directory**

Find or infer the phase directory path: `projects/pi-lawyer-os/.planning/phases/0{phase_number}-{name}/`

**Step 3: Create the PLAN.md**

Write `projects/pi-lawyer-os/.planning/phases/0{phase_number}-{name}/PLAN.md` with this structure:
...
**File:** projects/pi-lawyer-os/.planning/phases/0{N}-{name}/PLAN.md
**Waves:** {count}
**Total tasks:** {count}
