...
Read:
1. `.planning/phases/0{phase_number}-*/PLAN.md` — the task plan to execute
2. `.planning/phases/0{phase_number}-*/01-CONTEXT.md` — tech decisions and specifics
3. `reference/` — architecture, schema, workflow references as needed

Confirm the plan exists. If it doesn't, tell the user to run `/gsd:plan-phase {phase_number}` first.

**Step 2: Update STATE.md**

Set phase {phase_number} status to "In Progress" in `.planning/STATE.md`.
