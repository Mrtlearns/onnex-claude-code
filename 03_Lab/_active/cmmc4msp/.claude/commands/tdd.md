...
Run it. **It must fail.** If it passes, the test is wrong — either the code already exists
or the assertion isn't testing what you think it is.
...
- Writing production code before the test (obvious but easy to slip into)
- Writing multiple tests before writing any production code (lose the RED feedback)
