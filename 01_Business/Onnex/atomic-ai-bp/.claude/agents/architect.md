...
- Stack: Python, n8n, Docker, Supabase (Postgres + pgvector), Redis, Next.js
- Infra: Proxmox homelab, poc-backend (10.10.110.34), Traefik reverse proxy
- Never design for hypothetical scale — design for the actual load
- Prefer Docker Compose over Kubernetes for this stack
