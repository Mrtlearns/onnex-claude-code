...
(async () => {
  ...
  await page.screenshot({ path: 'D:\\Code\\gitlab.botonomy.xyz\\claude-workspace-pro\\projects\\ndt-portal-v1\\files\\test_01_loaded.png' });
  ...
  await page.screenshot({ path: 'D:\\Code\\gitlab.botonomy.xyz\\claude-workspace-pro\\projects\\ndt-portal-v1\\files\\test_02_after_upload.png' });
  ...
  await page.screenshot({ path: 'D:\\Code\\gitlab.botonomy.xyz\\claude-workspace-pro\\projects\\ndt-portal-v1\\files\\test_03_pipeline_started.png' });

  if (intakeId) {
    fs.writeFileSync('D:\\Code\\gitlab.botonomy.xyz\\claude-workspace-pro\\projects\\ndt-portal-v1\\files\\last_intake_id.txt', intakeId);
