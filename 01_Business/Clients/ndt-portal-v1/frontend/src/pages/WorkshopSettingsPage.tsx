...
import { WorkshopSettingsPanel } from '@/components/workshop/WorkshopSettings'
  ...
  return (
    <div className="min-h-full bg-[var(--ws-bg-primary)]">
      <div className="flex items-center gap-3 px-6 py-4 border-b border-[var(--ws-lane-border)] bg-[var(--ws-bg-secondary)]">
        ...
        <h1 className="text-base font-semibold text-[var(--ws-text-primary)]">Workshop Settings</h1>
      </div>
