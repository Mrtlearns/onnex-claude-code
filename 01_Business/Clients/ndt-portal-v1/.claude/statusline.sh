...
# Custom Claude Code statusline - Created: 2026-03-25T16:43:49.896Z
...
version_color() { if [ "$use_color" -eq 1 ]; then printf '\033[38;5;180m'; fi; }
cc_version_color() { if [ "$use_color" -eq 1 ]; then printf '\033[38;5;249m'; fi; }
style_color() { if [ "$use_color" -eq 1 ]; then printf '\033[38;5;245m'; fi; }
rst() { if [ "$use_color" -eq 1 ]; then printf '\033[0m'; fi; }
...
# ---- usage colors ----
usage_color() { if [ "$use_color" -eq 1 ]; then printf '\033[38;5;189m'; fi; }
cost_color() { if [ "$use_color" -eq 1 ]; then printf '\033[38;5;222m'; fi; }
burn_color() { if [ "$use_color" -eq 1 ]; then printf '\033[38;5;220m'; fi; }
session_color() {
  rem_pct=$(( 100 - session_pct ))
  if   (( rem_pct <= 10 )); then SCLR='38;5;210'
  elif (( rem_pct <= 25 )); then SCLR='38;5;228'
